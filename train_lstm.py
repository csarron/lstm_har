...
if __name__ == "__main__":
    ...
    data_util.zip_files("model/{}.ckpt.zip".format(model_name), "model/{}.ckpt.*".format(model_name))
    data_util.zip_files("model/{}.model.zip".format(model_name), "model/{}.pb*".format(model_name))
